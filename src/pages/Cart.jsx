              ...
              <div className='flex items-start gap-6'>
                ...
                <div>
                  ...
                  <div className='flex items-center gap-5 mt-2'>
                    <p>{formatPrice(productData.price, currency, 'id-ID')}</p>
                    <p className='px-2 sm:px-3 sm:py-1 border bg-slate-50'>{item.variants}</p>
                  </div>
                </div>
              </div>
              <input
                ...
                min={1}
                value={item.quantity}
                onChange={(e) => updateQuantity(item._id, item.variants, parseInt(e.target.value))}
              />
              <img
                onClick={() => updateQuantity(item._id, item.variants, 0)}
